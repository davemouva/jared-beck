                ...
                <div className="projectPage">
                    <div className="projectContainer">
                        ...
                        <section className="description">
                            ...
                            <p>The fountain pin is representative of where their ceremony took place, a little park called Libby Hill in Richmond, Va. The hotel where their reception took place is an awesome Wes Anderson-esque spot called Quirk Hotel, and that cute little frenchie there is my nephew Beaux.</p>
                        </section>
                    </div>
                </div>
                <Footer />
